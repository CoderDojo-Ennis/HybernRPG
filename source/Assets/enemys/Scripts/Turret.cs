...
public class Turret : EnemyFramework {
	...
	private bool SearchBeam(float angle)
	{
        ...
        Vector2 origin = transform.position + new Vector3(Mathf.Cos(angle + 90 * yScale) * 0.2f, Mathf.Sin(angle + 90 * yScale) * 0.2f, 0); //this probably isnt nessessary for the actual turret costume. For this current costume the laser needed to be offset
